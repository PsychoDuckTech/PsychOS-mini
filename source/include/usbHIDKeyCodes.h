...
/* Custom keys - using high address space to avoid conflicts (0xa5-0xaf range) */
#define KEY_C_CEDILLA 0xa5         // Keyboard ç and Ç
#define KEY_LESS_GREATER 0xa6      // Keyboard < and >
#define KEY_MINUS_UNDERSCORE 0x2d  // Same as KEY_MINUS, kept for compatibility
#define KEY_PLUS_ASTERISK 0xa7     // Keyboard + and *
#define KEY_ACUTE_GRAVE 0xa8       // Keyboard ´ and `
#define KEY_CIRCUMFLEX_TILDE 0xa9  // Keyboard ^ and ~
